<x-app-layout title="Prolifearmy | Agregar Libro">
    <div class="p-4">
                    ...
                    <div class="max-w-md mx-auto">
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
                                <h2 class="leading-relaxed">Nuevo Libro</h2>
                                <p class="text-sm text-gray-500 font-normal leading-relaxed">Llena este formulario para publicar un nuevo libro.</p>
                            </div>
                        </div>
                        <div class="divide-y divide-gray-200">
                            <form action="{{ route('book_store') }}" enctype="multipart/form-data" method="POST">
                                @csrf

                                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    <div class="flex flex-col">
                                        <label class="leading-loose">Nombre Libro</label>
                                        <input type="text" name="name" onkeyup="mayus(this);" style="text-transform: uppercase;" class="px-4 py-2 border focus:ring-gray-500 focus:border-green-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" placeholder="Nombre Libro" required autofocus>
                                    </div>
                                    <div class="flex flex-col">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <label class="w-full flex flex-col items-center px-4 py-2 bg-white text-blue-500 rounded-lg shadow-lg tracking-wide uppercase border border-blue-500 cursor-pointer hover:bg-blue-500 hover:text-white">
                                            ...
                                            <input type='file' accept="image/png, image/jpeg, image/jpg" id="cover_file" name="cover_file" hidden required/>
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <label class="w-full flex flex-col items-center px-4 py-2 bg-white text-blue-500 rounded-lg shadow-lg tracking-wide uppercase border border-blue-500 cursor-pointer hover:bg-blue-500 hover:text-white">
                                            ...
                                            <input type='file' accept=".pdf" id="book_file" name="book_file" hidden required/>
                                        </label>
                                    </div>
