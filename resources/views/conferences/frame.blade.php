        ...
        <div class="w-full overflow-hidden rounded-lg">
            ...
            <div class="text-center">
                ...
                <div class="text-center my-3">
                    ...
                    <h1 class="text-4xl">¡Disfruta esta conferencia {{ Auth::user()->name }}! </h1>

                    <h3 class="text-2xl">CONFERENCIA {{ $conference->name }} </h3>
                        ...
                        <app-landing _nghost-xee-c178="" class="ng-star-inserted">
                            ...
                            <div _ngcontent-xee-c178="" class="landing-container">
                                <div _ngcontent-xee-c178="" class="general-container">
                                    <div _ngcontent-xee-c178="" class="container-left responsive-width">
                                        <!---->
                                                        ...
                                                        <div _ngcontent-xee-c173=""
                                                            ...
                                                            <div _ngcontent-xee-c173="" class="container-video w-100">
                                                                <iframe _ngcontent-xee-c173="" width="100%" height="550"
                                                                    ...
                                                                    allowfullscreen=""
                                                                    src="{{ $conferenceUrl }}"
                                                                    class="ng-star-inserted"frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                                <!---->
