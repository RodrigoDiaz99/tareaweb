<x-app-layout title="Prolifearmy | Conferencias">
    <div class="p-4">
            ...
            <div
                ...
                <div class="text-center">
                    @if (Session::has('success'))
                        <div class="bg-green-100 rounded-md p-3 mb-2 flex">
                            ...
                            <div class="text-green-700">
                                <div class="font-bold text-xl">Video subido</div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="text-center my-3">
                        <h1 class="text-4xl">¡Bienvenido al catalogo de conferencias {{ Auth::user()->name }}! </h1>
                        @role('Super-Admin')
                        <p>Aquí el super administrador podrá realizar las modificaciones pertinentes a las conferencias
                        </p>
                        @endrole
                        @role('Admin')
                        <p>Aquí el administrador podrá realizar las modificaciones pertinentes a las conferencias</p>
                        @endrole
                        ...
                        @forelse ($conference as $row)
                            <div class="max-w-sm w-full sm:w-1/2 lg:w-1/3 py-3 px-3">
                                <div
                                    ...
                                    <div class="p-4">
                                        <p class="text-md italic bg-gray-50 dark:text-gray-400 dark:bg-gray-800">Conferencia</p>
                                    ...
                                    <div class="flex p-4 border-t border-gray-300 text-gray-700">
                                        <div class="flex-1 inline-flex justify-between items-center">
                                            <a href="{{route('conference_frame',$row->id)}}"
                                            ...
                                            <a href="{{ route('conference_edit', $row->id) }}"
                                            ...
                                            <form action="{{ route('conference_destroy', $row->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button
