            ...
            <div
                ...
                <div class="text-center">
                    ...
                    <div class="text-center my-3">
                        ...
                        <p>Aquí podras ver todo el catalogo de nuestras conferencias que tenemos</p>
                                    ...
                                    <div class="flex text-center p-4 border-t border-gray-300 text-gray-700">
                                        <div class="flex-1 inline-flex items-center">
                                            <a  href="{{route('conference_frame',$row->id)}}"
                                                class="w-full flex-col bg-transparent hover:bg-blue-400 text-blue-500 font-semibold hover:text-white py-2 px-4 border border-blue-400 hover:border-transparent rounded">
