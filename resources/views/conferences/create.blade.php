<x-app-layout title="Prolifearmy | Agregar Conferencia">
    <div class="p-4">
                ...
                <div class="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
                    ...
                    <div class="max-w-md mx-auto">
                        <div class="flex items-center space-x-5">
                            <div class="h-14 w-14 bg-yellow-200 rounded-full flex flex-shrink-0 justify-center items-center text-yellow-500 text-2xl font-mono">SC</div>
                            <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
                                <h2 class="leading-relaxed">Subir Conferencia</h2>
                                <p class="text-sm text-gray-500 font-normal leading-relaxed">Llena este formulario para publicar una nueva conferencia.</p>
                            </div>
                        </div>
                        <div class="divide-y divide-gray-200">
                            <form action="{{ route('conference_store') }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                ...
                                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <div class="flex flex-col">
                                        <label class="leading-loose">Link de la conferencia</label>
                                        <input type="url" name="link" id="link" class="px-4 py-2 border focus:ring-gray-500 focus:border-green-500 w-full sm:text-sm border-blue-500 rounded-md focus:outline-none text-gray-600" placeholder="Link de la conferencia" required autofocus>
                                    </div>
                                ...
                                <div class="pt-4 flex items-center space-x-4">
                                    ...
                                    <button type="submit" class="w-full flex-col bg-transparent hover:bg-green-400 text-green-500 font-semibold hover:text-white py-2 px-1 border border-green-400 hover:border-transparent rounded">
                                        ...
                                        <span>Publicar conferencia</span>
                                    </button>
