<x-app-layout title="Prolifearmy ">
    <div class="p-4">
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 text-gray-700 dark:text-gray-400">
            <form action="{{ route('contentabout_update', $content2->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="flex-1">
                        <label class="block mt-4 text-sm">
                            <label class="block text-sm">
                                ...
                                value="{{ $content2->title }}"  name="title"    autofocus required>
                    ...
                    <div class="flex-1">
                        <label class="block mt-4 text-sm">
                            <label class="block text-sm">
                                ...
                                value="{{ $content2->sub_title }}" name="sub_title"    required>
