            ...
            <div
                ...
                <div class="text-center my-3">
                    ...
                    <p class="text-center font-italic">En esta sección se hace la administración del contenido de la
                        página principal
                        en
                        donde se podrá establecer los datos del contenido principal, así como lo que va junto a la imagen.</p>
                  
                    @if (count($contents) > 0)
                    @else
                    <div class="btn-group py-2">
                        <a href="{{ route('contentup_create') }}"
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">Primer parrafo</th>

                            <th class="px-4 py-3">Segundo parrafo</th>
                            <th class="px-4 py-3">Tercer parrafo</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        <p class="font-semibold">{{ $row->first_paragraph }}</p>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <a href="{{ route('contentup_edit', $row->id) }}"
