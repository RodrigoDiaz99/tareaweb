...
<head>
    ...
    <style>
        .textura{
            background-image: url("https://res.cloudinary.com/hfakqpuzy/image/upload/v1613718980/Editable_PLA_2_muwji4.png");
        }
    </style>

<body>
    <div class="flex h-screen textura bg-gray-100 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        @include('layouts.menu')
        @include('layouts.mobile-menu')

        <div class="flex flex-col flex-1 w-full">
            <header class="flex justify-between flex-wrap bg-dark-blue-200 text-cool-gray-700 dark:bg-dark-blue-500 dark:text-cool-gray-300 p-2">
